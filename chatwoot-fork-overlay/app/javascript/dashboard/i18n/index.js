// BLINKONE: Merges blinkone_overrides into dashboard i18n (see blinkoneMergeLocales.js)
import mergeBlinkoneLocales from './blinkoneMergeLocales';
...
export default mergeBlinkoneLocales({
  ar,
  bg,
  ca,
  cs,
